...
function resolveConfiguredModelRaw(cfg: TalonConfig): string {
...
function resolveConfiguredModelKeys(cfg: TalonConfig): string[] {
...
export function applyPrimaryModel(cfg: TalonConfig, model: string): TalonConfig {
...
export function applyModelAllowlist(cfg: TalonConfig, models: string[]): TalonConfig {
  const defaults = cfg.agents?.defaults;
