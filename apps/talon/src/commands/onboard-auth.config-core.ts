...
export function applyZaiConfig(cfg: TalonConfig): TalonConfig {
...
export function applyOpenrouterProviderConfig(cfg: TalonConfig): TalonConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayProviderConfig(cfg: TalonConfig): TalonConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayConfig(cfg: TalonConfig): TalonConfig {
...
export function applyOpenrouterConfig(cfg: TalonConfig): TalonConfig {
...
export function applyMoonshotProviderConfig(cfg: TalonConfig): TalonConfig {
  return applyMoonshotProviderConfigWithBaseUrl(cfg, MOONSHOT_BASE_URL);
}

export function applyMoonshotProviderConfigCn(cfg: TalonConfig): TalonConfig {
...
export function applyMoonshotConfig(cfg: TalonConfig): TalonConfig {
...
export function applyMoonshotConfigCn(cfg: TalonConfig): TalonConfig {
...
export function applyKimiCodeProviderConfig(cfg: TalonConfig): TalonConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: TalonConfig): TalonConfig {
...
export function applySyntheticProviderConfig(cfg: TalonConfig): TalonConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: TalonConfig): TalonConfig {
...
export function applyXiaomiProviderConfig(cfg: TalonConfig): TalonConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: TalonConfig): TalonConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: TalonConfig): TalonConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: TalonConfig): TalonConfig {
...
export function applyXaiProviderConfig(cfg: TalonConfig): TalonConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXaiConfig(cfg: TalonConfig): TalonConfig {
