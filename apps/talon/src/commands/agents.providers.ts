...
function resolveDefaultAccountId(cfg: TalonConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: TalonConfig): boolean {
...
export function summarizeBindings(cfg: TalonConfig, bindings: AgentBinding[]): string[] {
