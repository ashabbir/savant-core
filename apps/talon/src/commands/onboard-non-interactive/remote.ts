...
export async function runNonInteractiveOnboardingRemote(params: {
  ...
  if (opts.json) {
    ...
    runtime.log(
      `Tip: run \`${formatCliCommand("talon configure --section web")}\` to store your Brave API key for web_search. Docs: See README.md`
    );
  }
}
