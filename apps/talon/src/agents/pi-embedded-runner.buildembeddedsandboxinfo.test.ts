...
const _makeOpenAiConfig = (modelIds: string[]) =>
  ...
  }) satisfies TalonConfig;

const _ensureModels = (cfg: TalonConfig, agentDir: string) =>
  ensureTalonModelsJson(cfg, agentDir) as unknown;
...
describe("buildEmbeddedSandboxInfo", () => {
  ...
  it("maps sandbox context into prompt info", () => {
    const sandbox = {
      ...
      workspaceDir: "/tmp/talon-sandbox",
      agentWorkspaceDir: "/tmp/talon-workspace",
      ...
      browser: {
        ...
        containerName: "talon-sbx-browser-test",
      },
