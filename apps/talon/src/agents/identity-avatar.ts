...
function resolveAvatarSource(cfg: TalonConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: TalonConfig, agentId: string): AgentAvatarResolution {
