...
const getChannelDock = (channel: string): any => undefined;
const resolveChannelGroupToolsPolicy = (params: any): any => undefined;
...
export function resolveSubagentToolPolicy(cfg?: TalonConfig): SandboxToolPolicy {
