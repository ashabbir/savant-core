...
// pi-ai's built-in Anthropic catalog can lag behind Talon's defaults/docs.
...
export function buildModelAliasLines(cfg?: TalonConfig) {
...
export function resolveModel(
  ...
  const resolvedAgentDir = agentDir ?? resolveTalonAgentDir();
