...
type WebSearchConfig = NonNullable<TalonConfig["tools"]>["web"] extends infer Web
...
function resolveSearchConfig(cfg?: TalonConfig): WebSearchConfig {
...
function missingSearchKeyPayload(provider: (typeof SEARCH_PROVIDERS)[number]) {
  ...
  return {
    ...
    message: `web_search needs a Brave Search API key. Run \`${formatCliCommand("talon configure --section web")}\` to store it, or set BRAVE_API_KEY in the Gateway environment.`,
    docs: "See README.md",
  };
}
