...
export class DirectoryCache<T> {
  ...
  private lastConfigRef: TalonConfig | null = null;

  constructor(private readonly ttlMs: number) {}

  get(key: string, cfg: TalonConfig): T | undefined {
  ...
  set(key: string, value: T, cfg: TalonConfig): void {
    this.resetIfConfigChanged(cfg);
  ...
  private resetIfConfigChanged(cfg: TalonConfig): void {
