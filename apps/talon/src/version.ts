...
declare const __TALON_VERSION__: string | undefined;
const CORE_PACKAGE_NAME = "talon";
...
// Single source of truth for the current Talon version.
// - Embedded/bundled builds: injected define or env var.
// - Dev/npm builds: package.json.
export const VERSION =
  (typeof __TALON_VERSION__ === "string" && __TALON_VERSION__) ||
  process.env.TALON_BUNDLED_VERSION ||
