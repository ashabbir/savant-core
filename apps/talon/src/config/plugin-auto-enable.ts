...
function isTelegramConfigured(cfg: TalonConfig, env: NodeJS.ProcessEnv): boolean {
...
function isDiscordConfigured(cfg: TalonConfig, env: NodeJS.ProcessEnv): boolean {
...
function isSlackConfigured(cfg: TalonConfig, env: NodeJS.ProcessEnv): boolean {
  if (
...
function isSignalConfigured(cfg: TalonConfig): boolean {
...
function isIMessageConfigured(cfg: TalonConfig): boolean {
...
function isWhatsAppConfigured(cfg: TalonConfig): boolean {
...
function isGenericChannelConfigured(cfg: TalonConfig, channelId: string): boolean {
...
function collectModelRefs(cfg: TalonConfig): string[] {
  const refs: string[] = [];
...
function isProviderConfigured(cfg: TalonConfig, providerId: string): boolean {
...
function isPluginExplicitlyDisabled(cfg: TalonConfig, pluginId: string): boolean {
  const entry = cfg.plugins?.entries?.[pluginId];
  return entry?.enabled === false;
}

function isPluginDenied(cfg: TalonConfig, pluginId: string): boolean {
...
function ensureAllowlisted(cfg: TalonConfig, pluginId: string): TalonConfig {
...
function enablePluginEntry(cfg: TalonConfig, pluginId: string): TalonConfig {
  const entries = {
    ...cfg.plugins?.entries,
    [pluginId]: {
