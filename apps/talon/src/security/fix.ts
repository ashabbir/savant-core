...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof TalonConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: TalonConfig; env: NodeJS.ProcessEnv }): {
  cfg: TalonConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
