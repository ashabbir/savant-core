...
import { type TalonConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: TalonConfig): string[] {
...
export function listAgentsForGateway(cfg: TalonConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: TalonConfig): string {
...
function resolveSessionStoreAgentId(cfg: TalonConfig, canonicalKey: string): string {
...
export function resolveGatewaySessionStoreTarget(params: { cfg: TalonConfig; key: string }): {
  agentId: string;
  storePath: string;
  canonicalKey: string;
  storeKeys: string[];
...
export function loadCombinedSessionStoreForGateway(cfg: TalonConfig): {
  storePath: string;
...
export function getSessionDefaults(cfg: TalonConfig): GatewaySessionsDefaults {
