...
import type { TalonConfig, ConfigFileSnapshot, GatewayReloadMode } from "../config/config.js";
...
export function resolveGatewayReloadSettings(cfg: TalonConfig): GatewayReloadSettings {
...
export function startGatewayConfigReloader(opts: {
  initialConfig: TalonConfig;
  readSnapshot: () => Promise<ConfigFileSnapshot>;
  onHotReload: (plan: GatewayReloadPlan, nextConfig: TalonConfig) => Promise<void>;
  onRestart: (plan: GatewayReloadPlan, nextConfig: TalonConfig) => void;
  log: {
