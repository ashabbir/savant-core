...
import type { TalonConfig } from "../config/types.js";
...
export const DEFAULT_LOG_DIR = "/tmp/talon";
export const DEFAULT_LOG_FILE = path.join(DEFAULT_LOG_DIR, "talon.log"); // legacy single-file path

const LOG_PREFIX = "talon";
...
function resolveSettings(): ResolvedSettings {
  let cfg: TalonConfig["logging"] | undefined =
    (loggingState.overrideSettings as LoggerSettings | null) ?? readLoggingConfig();
  if (!cfg) {
    try {
      const loaded = requireConfig("../config/config.js") as {
        loadConfig?: () => TalonConfig;
      };
