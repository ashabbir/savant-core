...
export type PluginCandidate = {
  ...
  packageDir?: string;
  packageManifest?: TalonPackageManifest;
};
...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @talon/voice-call -> voice-call).
...
export function discoverTalonPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".talon", "extensions")];
