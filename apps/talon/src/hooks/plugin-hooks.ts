...
import type { TalonPluginApi } from "../plugins/types.js";
...
function resolveHookDir(api: TalonPluginApi, dir: string): string {
...
function normalizePluginHookEntry(api: TalonPluginApi, entry: HookEntry): HookEntry {
  return {
    ...entry,
    hook: {
      ...entry.hook,
