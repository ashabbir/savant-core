...
const SANDBOX_EXAMPLES = {
  main: [
    ["talon sandbox list", "List all sandbox containers."],
    ["talon sandbox list --browser", "List only browser containers."],
    ["talon sandbox recreate --all", "Recreate all containers."],
    ["talon sandbox recreate --session main", "Recreate a specific session."],
    ["talon sandbox recreate --agent mybot", "Recreate agent containers."],
    ["talon sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["talon sandbox list", "List all sandbox containers."],
    ["talon sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ["talon sandbox recreate --all", "Recreate all containers."],
    ["talon sandbox recreate --session main", "Recreate a specific session."],
    ["talon sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["talon sandbox recreate --browser --all", "Recreate only browser containers."],
    ["talon sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["talon sandbox explain", "Show effective sandbox config."],
    ["talon sandbox explain --session agent:main:main", "Explain a specific session."],
    ["talon sandbox explain --agent work", "Explain an agent sandbox."],
    ["talon sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.talon.ai/cli/sandbox")}\n`,
    )
    .action(() => {
