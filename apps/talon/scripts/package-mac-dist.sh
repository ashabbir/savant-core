...
# Output:
# - dist/Talon.app
# - dist/Talon-<version>.zip
# - dist/Talon-<version>.dmg
...
ZIP="$ROOT_DIR/dist/Talon-$VERSION.zip"
DMG="$ROOT_DIR/dist/Talon-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/Talon-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/Talon-$VERSION.dSYM.zip"
