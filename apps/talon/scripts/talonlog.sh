...
show_usage() {
    cat << EOF
clawlog - Talon Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View Talon logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    Talon logs flow through the macOS unified log (subsystem: ai.talon).
