---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with Talon"
read_when:
  - You want Xiaomi MiMo models in Talon
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). Talon uses
