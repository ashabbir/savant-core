...
You can point Talon at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Talon
...
- [Anthropic provider](/providers/anthropic) - Native Talon integration with Claude setup-token or API keys
