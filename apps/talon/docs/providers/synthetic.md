---
summary: "Use Synthetic's Anthropic-compatible API in Talon"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. Talon registers it as the
...
Note: Talon's Anthropic client appends `/v1` to the base URL, so use
