---
summary: "Hubs that link to every Talon doc"
read_when:
...
<Note>
If you are new to Talon, start with [Getting Started](/start/getting-started).
</Note>
...
- [Skills](/tools/skills)
- [Talon Registry](/tools/talon-registry)
