---
summary: "First-run onboarding flow for Talon (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give Talon">
...
<Step title="CLI">
  ...
  The app can install the global `talon` CLI via npm/pnpm so terminal
