...
- Same path: run the app from a fixed location (for Talon, `dist/Talon.app`).
...
Workaround: move files into the Talon workspace (`~/.talon/workspace`) if you want to avoid per-folder grants.
