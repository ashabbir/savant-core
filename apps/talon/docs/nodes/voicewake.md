...
Talon treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.talon/settings/voicewake.json`

Shape:

```json
{ "triggers": ["talon", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
