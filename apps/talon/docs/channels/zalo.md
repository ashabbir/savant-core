...
- Install via CLI: `talon plugins install @talon/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `talon plugins install ./extensions/zalo`
   - From npm (if published): `talon plugins install @talon/zalo`
...
- Approve via:
  - `talon pairing list zalo`
  - `talon pairing approve zalo <CODE>`
...
- Example: `talon message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `talon channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `talon logs --follow`
