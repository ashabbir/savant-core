...
Talon has two separate “streaming” layers:
...
When block streaming is enabled, Talon can **merge consecutive block chunks**
...
When draft streaming is active, Talon disables block streaming for that reply to avoid double-streaming.
