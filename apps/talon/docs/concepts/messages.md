...
This page ties together how Talon handles inbound messages, sessions, queueing,
...
Channels can redeliver the same message after reconnects. Talon keeps a
...
Talon separates the **prompt body** from the **command body**:
...
Talon can expose or hide model reasoning:
