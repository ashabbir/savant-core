...
read_when:
  - You are building a Talon plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (talon.plugin.json)

Every plugin **must** ship a `talon.plugin.json` file in the **plugin root**.
Talon uses this manifest to validate configuration **without executing plugin
